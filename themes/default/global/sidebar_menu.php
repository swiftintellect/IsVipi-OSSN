    ...
    <!-- left, vertical navbar -->
       <div class="col-md-4">
           <ul class="nav navbar-collapse collapse sidebar-menu">
               ...
               <?php global $username?>
               <?php if ($_SESSION['user_id'] != 0){?><li <?php if ($ACTION[0]=="profile"){echo "class='active'";}?>><a href="<?php echo ISVIPI_URL.'profile/' ?><?php echo htmlspecialchars($username, ENT_QUOTES, 'utf-8');?>" title="<?php echo MY_PROFILE ?>"><i class="fa fa-eye-slash"></i> <?php echo PROFILE ?></a></li>
