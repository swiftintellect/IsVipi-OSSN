    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <p class="lead">Seems like you have not yet set up your site. Don't worry, hit the button below to proceed.</p>
                <ul class="list-unstyled">
                    <li><a href="isv_install/" class="btn btn-default btn-lg">Install isVipi OSSN</a></li>
                </ul>
            </div>
        </div>
        <!-- /.row -->
