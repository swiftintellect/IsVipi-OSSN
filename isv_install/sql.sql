...
--
-- Table structure for table `s_meta`
--
...
--
-- Table structure for table `feed_comment_likes`
--
...
--
-- Table structure for table `feed_notices`
--
...
CREATE TABLE IF NOT EXISTS `feed_comments` (
  ...
  `user_id` bigint(20) NOT NULL,
  `feed_id` bigint(20) NOT NULL,
  `feed_comment` longtext COLLATE utf8_unicode_ci NOT NULL,
  `time` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `scheduled_del`
--
CREATE TABLE IF NOT EXISTS `scheduled_del` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL UNIQUE,
  `scheduled_by` bigint(20) NOT NULL,
